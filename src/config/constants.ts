...
export const TOKENS = {
  ...
  TEXT_OBJECT_BACKTICK: 'TEXT_OBJECT_BACKTICK',
  TEXT_OBJECT_ACUTE: 'TEXT_OBJECT_ACUTE',
...
const TOKEN_SEQUENCE_MAP: Readonly<Record<string, string>> = {
  ...
  [TOKENS.DOC_MIDDLE]: MIV_KEYS.commands.docMiddle,
  ...
  [TOKENS.TEXT_OBJECT_BACKTICK]: MIV_KEYS.textObjects.backtick,
  [TOKENS.TEXT_OBJECT_ACUTE]: MIV_KEYS.textObjects.acute,
